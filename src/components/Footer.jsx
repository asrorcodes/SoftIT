...
const Footer = () => {
  ...
  return (
    <>
      ...
      />
      <motion.footer
        className="text-white py-8 z-20 relative"
        style={{
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-[3]">
          {/* Navigation Links */}
          <motion.nav
            className="grid grid-cols-1 sm:grid-cols-1 lg:flex gap-6 lg:gap-12 mb-16 text-[22px]"
            variants={containerVariants}
          >
            {[
          ...
          <motion.div
            className="flex gap-16 items-center justify-between mb-8"
          ...
          >
            <div className="flex flex-col md:flex-row gap-6 md:gap-16 mb-12">
              ...
              >
                ...
                >
                  <g opacity="0.7">
                    ...
                    <path
                      d="M19.75 22.9375H12.25C9.5125 22.9375 7.9375 21.3625 7.9375 18.625V13.375C7.9375 10.6375 9.5125 9.0625 12.25 9.0625H19.75C22.4875 9.0625 24.0625 10.6375 24.0625 13.375V18.625C24.0625 21.3625 22.4875 22.9375 19.75 22.9375ZM12.25 10.1875C10.105 10.1875 9.0625 11.23 9.0625 13.375V18.625C9.0625 20.77 10.105 21.8125 12.25 21.8125H19.75C21.895 21.8125 22.9375 20.77 22.9375 18.625V13.375C22.9375 11.23 21.895 10.1875 19.75 10.1875H12.25Z"
                      fill="white"
                    />
                    <path
                      d="M15.9998 16.6525C15.3698 16.6525 14.7323 16.4575 14.2448 16.06L11.8973 14.185C11.6573 13.99 11.6123 13.6375 11.8073 13.3975C12.0023 13.1575 12.3548 13.1125 12.5948 13.3075L14.9423 15.1825C15.5123 15.64 16.4798 15.64 17.0498 15.1825L19.3973 13.3075C19.6373 13.1125 19.9973 13.15 20.1848 13.3975C20.3798 13.6375 20.3423 13.9975 20.0948 14.185L17.7473 16.06C17.2673 16.4575 16.6298 16.6525 15.9998 16.6525Z"
                      fill="white"
                    />
                  </g>
                </svg>
                <a
                  href="mailto:softit@info.uz"
                  className="text-[20px] text-base hover:text-white transition-colors duration-300"
                >
                  softit@info.uz
                </a>
              </motion.div>
              ...
              >
                ...
                <a
                  ...
                  className="hover:text-white text-base text-[20px] transition-colors duration-300"
                >
                  +99893 123 45 67
                </a>
              </motion.div>
            ...
            >
              ...
              >
                <path
                  d="M26 49.2918C13.1517 49.2918 2.70837 38.8485 2.70837 26.0002C2.70837 13.1518 13.1517 2.7085 26 2.7085C38.8484 2.7085 49.2917 13.1518 49.2917 26.0002C49.2917 38.8485 38.8484 49.2918 26 49.2918ZM26 5.9585C14.95 5.9585 5.95837 14.9502 5.95837 26.0002C5.95837 37.0502 14.95 46.0418 26 46.0418C37.05 46.0418 46.0417 37.0502 46.0417 26.0002C46.0417 14.9502 37.05 5.9585 26 5.9585Z"
                  fill="white"
                  fillOpacity="0.6"
                />
                <path
                  d="M26 35.2085C25.1117 35.2085 24.375 34.4718 24.375 33.5835V20.5835C24.375 19.6952 25.1117 18.9585 26 18.9585C26.8883 18.9585 27.625 19.6952 27.625 20.5835V33.5835C27.625 34.4718 26.8883 35.2085 26 35.2085Z"
                  fill="white"
                  fillOpacity="0.6"
                />
                <path
                  d="M32.5 26.5415C32.0883 26.5415 31.6766 26.3898 31.3516 26.0648L26 20.7131L20.6483 26.0648C20.02 26.6931 18.98 26.6931 18.3516 26.0648C17.7233 25.4365 17.7233 24.3965 18.3516 23.7681L24.8516 17.2681C25.48 16.6398 26.52 16.6398 27.1483 17.2681L33.6483 23.7681C34.2766 24.3965 34.2766 25.4365 33.6483 26.0648C33.3233 26.3898 32.9116 26.5415 32.5 26.5415Z"
                  fill="white"
                  fillOpacity="0.6"
                />
              </svg>
          ...
          <motion.div
            ...
            variants={itemVariants}
          >
            <div className="text-gray-400 order-2 md:order-1 text-lg">
              © 2023 Soft IT Group
            </div>
