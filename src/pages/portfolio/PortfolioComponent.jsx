  ...
  const portfolioEls = projectItems.map((item, index) => (
    <motion.div
      className={classNames(
        "group relative w-full overflow-hidden rounded-2xl min-h-[250px] sm:min-h-[300px] border-2 border-white hover:border-gray-400 transition-colors duration-300",
      ...
      <div className="container mx-auto px-4">
        ...
        {asSection && (
          ...
          >
            <Link
              to="/portfolio"
              className="inline-flex w-max items-center gap-1 sm:gap-2 rounded-lg px-4 sm:px-6 py-1.5 sm:py-2 bg-gray-800 text-white transition-all duration-300 hover:bg-gray-700 hover:text-white hover:shadow-lg hover:shadow-gray-500 group focus:outline-none focus:ring-2 focus:ring-gray-600 focus:ring-opacity-50"
              whileTap={{ scale: 0.95 }}
            >
              <ArrowRightCircle 
