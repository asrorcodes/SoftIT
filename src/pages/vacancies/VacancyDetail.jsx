  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Header Section */}
        <div className="bg-zinc-900 rounded-t-xl p-6 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">{title}</h1>
              <div className="flex flex-wrap gap-2 mt-3">
                <span className="bg-[#D13291] text-white px-3 py-1 rounded-full text-sm">
                  {category}
                </span>
                <span className="bg-[#D13291] text-white px-3 py-1 rounded-full text-sm">
                  {level}
        ...
        {/* Main Content */}
        <div className="bg-zinc-900 rounded-b-xl p-6 md:p-8 space-y-8">
          {/* Basic Info */}
          ...
          {/* Responsibilities */}
          <div>
            <h2 className="text-2xl font-bold text-white mb-4 flex items-center border-b border-gray-700 pb-2">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 gap-4">
              {conditions.map((item, index) => (
                <div key={index} className="bg-gray-700 p-3 rounded-lg flex items-start">
          ...
          {/* Apply Button */}
          <div className="pt-6">
            <button onClick={() => setIsModalOpen(true)} className="w-full bg-[#D13291] hover:bg-[#D14291] text-white font-bold py-3 px-4 rounded-lg transition duration-200 flex items-center justify-center">
          ...
          {isModalOpen && (
            <div className="fixed inset-0  bg-black bg-opacity-60 flex items-center justify-center p-4 z-50">
              <div  className="bg-[#0D0D0D]  rounded-none sm:rounded-xl lg:p-6 px-6 py-4 w-full lg:w-[800px] lg:h-[400px] h-[100vh] sm:h-auto sm:max-w-xl relative overflow-y-auto">
                <button
                ...
                <h3 className="text-2xl font-bold text-white mb-6">{t('vacancy.apply')}</h3>
...
<div className="grid grid-cols-1  lg:grid-cols-2 gap-6">
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <input
                      type="text"
                      className="w-full bg-[#121212] text-white rounded-lg border border-[#FFFFFF33] p-2 focus:outline-none focus:border-[#D13291]"
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <select
                      className="w-full bg-[#121212] text-white rounded-lg border border-[#FFFFFF33] p-2.5 focus:outline-none focus:border-[#D13291]"
                  ...
                  <div>
                    ...
                    <div className="border bg-[#121212]  flex items-center justify-between border-[#FFFFFF33] rounded-lg p-2 text-center">
                      ...
                      <label htmlFor="cv-upload" className="cursor-pointer flex items-center gap-5 text-gray-400 hover:text-white">
                  ...
                  <button
                    ...
                    type="submit"
                    className="w-full bg-[#D13291] col-span-2 text-white py-3 rounded-lg hover:bg-[#D14291] transition duration-200"
                  >
                    {t('vacancy.submit')}
                  </button>
</div>
