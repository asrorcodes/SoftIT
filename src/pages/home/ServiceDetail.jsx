...
const ServiceDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-[#080808] opacity-80 py-12 px-4">
      <div className="container mx-auto px-32">
        <div className="mb-8">
          <div className="flex cursor-pointer items-center gap-3 mb-4" onClick={()=>navigate(-1)}>
            <ArrowLeft className="text-gray-400" />
            <p className="text-gray-400 cursor-pointer " >{t('contact.back')}</p>
          </div>
          <h1 className="text-4xl font-bold text-white mb-8">
            {i18n.language === "PУ" ? service.title?.ru : i18n.language === "O'Z" ? service.title?.uz : service.title?.en}
          </h1>
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            {i18n.language === "PУ" ? service.description?.ru : i18n.language === "O'Z" ? service.description?.uz : service.description?.en}
          </p>

          <p className="text-gray-300 text-lg  leading-relaxed mb-12">
            {i18n.language === "PУ" ? service.longDesc?.ru : i18n.language === "O'Z" ? service.longDesc?.uz : service.longDesc?.en}

          </p>

          <section className="py-16">
            <div className="w-[1400px]  flex gap-4  mx-auto">
                <p className="text-gray-400 text-start">{t('contact.staff')}</p>
                <form onSubmit={onSubmitForm} className="w-full p-12 md:p-12 bg-[#0D0D0D] rounded-3xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-8">
                    <div className=" flex flex-col">
                      ...
                      <input
                        className="bg-[#121212] py-2 px-3 rounded-lg border-[0.5px] border-[#FFFFFF33] focus:outline-none hover:border-[#ffffff83]"
                    ...
                    <div className=" flex flex-col">
                      <label className="text-[16px] mb-4 text-white">{t('contact.projectType')}</label>
                      <select
                        value={form.project_type}
                        onChange={(e) => onFormChange('project_type', e.target.value)}
                        className="bg-[#121212] py-2 px-3 rounded-lg border-[0.5px] border-[#FFFFFF33] focus:border-[#ffffff83] hover:border-[#ffffff83] text-white w-full outline-none"
                      >
                    ...
                    <div className="col-span-full">
                      <div className="flex flex-col">
                        ...
                        <textarea
                          className="bg-[#121212] h-[120px] py-2 px-3 rounded-lg border-[0.5px] border-[#FFFFFF33] focus:outline-none hover:border-[#ffffff83]"
